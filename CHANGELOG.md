...
Every release is versioned with a semver git tag (`MAJOR.MINOR.PATCH`) on its merge commit — **major** = redesign or identity/structural shift, **minor** = new feature or notable enhancement, **patch** = fix, content, or docs. Entries are newest-first by version. See [GitHub Releases](https://github.com/vijaybpanangi/awonderfullife/releases) and `git tag` for the full list.

## v2.4.1 — Release governance: semver tags + versioned changelog + doc currency (2026-06-15)
...
## v2.4.0 — Liquid Glass editorial accents (2026-06-15)
...
## v2.3.1 — Contact email surfaced (v@) on About + Person JSON-LD (2026-06-15)
...
## v2.3.0 — Email live via iCloud+ Custom Email Domain (2026-06-15)
...
## v2.2.1 — Email DNS checker + hardened iCloud email plan (2026-06-15)
...
## v2.2.0 — Technical SEO foundation (no copy, design, or URL changes) (2026-06-15)
...
## v2.1.1 — India-Pakistan hero regenerated (series cohesion touch-up) (2026-06-15)
...
## v2.1.0 — API spine (Phase 1): `api.awonderfullife.ca` (2026-06-13)
...
## v2.0.0 — Quiet Magazine redesign + generated illustration series (2026-06-11)
...
## v1.0.0 — Editorial direction launch (2026-05-28)
