...
|---|---|---|---|
| `v3.0.0` | 2026-07-11 | [#PR_NUM] | Re-platform to Eleventy: posts are Markdown, all pages/feed/sitemap/SEO generated; parity-verified byte-faithful; zero visual change |
